...
function initiate() {
  document.getElementById("input-container").addEventListener("ontouchstart", function(){ touch = true; });
  document.getElementById("input-container").addEventListener("ontouchend", function(){ touch = false; play = 1; });
