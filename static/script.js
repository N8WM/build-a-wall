...
function initiate() {
  ...
  for (var i = 0; i < 17; i++) {
    for (var j = 0; j < 9; j++) {
      svg.innerHTML += "<image xlink:href='https://github.com/N8WM/build-a-wall/blob/master/brick.png?raw=true' width='" + getRealX(16) + "' x='" + getRealX(i*16 - ((j % 2) * 8)) + "' y='" + getRealY(j*16) + "'/>";
    }
  }
}
